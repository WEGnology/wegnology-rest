...
module.exports = function (options, client) {
   ...
   *  {hash} query - Experience group filter JSON object which overrides the filter and filterField fields. (https://api.app.wnology.io/#/definitions/advancedExperienceGroupQuery)
