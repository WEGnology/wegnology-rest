...
module.exports = function (options, client) {
   ...
   *
   * Responses:
   *  200 - Collection of resource jobs (https://api.app.wnology.io/#/definitions/resourceJobs)
   *
   * Errors:
   ...
   * Parameters:
   *  {string} applicationId - ID associated with the application
   *  {hash} resourceJob - New resource job information (https://api.app.wnology.io/#/definitions/resourceJobPost)
   *  {string} losantdomain - Domain scope of request (rarely needed)
   *  {boolean} _actions - Return resource actions in response
   *  {boolean} _links - Return resource link in response
   *  {boolean} _embedded - Return embedded resources in response
   *
   * Responses:
   *  201 - Successfully created resource job (https://api.app.wnology.io/#/definitions/resourceJob)
   *
   * Errors:
   *  400 - Error if malformed request (https://api.app.wnology.io/#/definitions/error)
   *  404 - Error if application was not found (https://api.app.wnology.io/#/definitions/error)
